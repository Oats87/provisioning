...
import (
	...
	provcluster "github.com/rancher/provisioning/controllers/provisioningv2/cluster"
	capicontrollers "github.com/rancher/provisioning/pkg/generated/controllers/cluster.x-k8s.io/v1beta1"
	provcontrollers "github.com/rancher/provisioning/pkg/generated/controllers/provisioning.cattle.io/v1"
...
// TODO: Fix this redefintion from "github.com/rancher/rancher/pkg/controllers/management/clusterconnected"
var (
...
func (h *handler) OnChange(obj *rkev1.RKEControlPlane, status rkev1.RKEControlPlaneStatus) (rkev1.RKEControlPlaneStatus, error) {
	...
	status.AgentConnected = Connected.IsTrue(cluster)
	return status, nil
}
