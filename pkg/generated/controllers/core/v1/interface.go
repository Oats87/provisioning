...
type Interface interface {
	ComponentStatus() ComponentStatusController
...
func (c *version) ComponentStatus() ComponentStatusController {
	return NewComponentStatusController(schema.GroupVersionKind{Group: "", Version: "v1", Kind: "ComponentStatus"}, "componentstatuses", false, c.controllerFactory)
}
...
func (c *version) LimitRange() LimitRangeController {
	return NewLimitRangeController(schema.GroupVersionKind{Group: "", Version: "v1", Kind: "LimitRange"}, "limitranges", true, c.controllerFactory)
}
...
func (c *version) ReplicationController() ReplicationControllerController {
	return NewReplicationControllerController(schema.GroupVersionKind{Group: "", Version: "v1", Kind: "ReplicationController"}, "replicationcontrollers", true, c.controllerFactory)
}
